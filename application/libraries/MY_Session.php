...
class MY_Session extends CI_Session {
    ...
    function destroy() {
        ...
        if ($this->alt_session_started) parent::sess_destroy();
    }
    ...
    function unset_userdata($newdata = array()) {
        if ($this->alt_session_started) parent::unset_userdata($newdata);
